...
export default function OrdersPage() {
  ...
  const handleAddItem = () => {
    setForm({
      ...form,
      items: [...form.items, { product_name: "", quantity: "", price: "" }],
    });
  };
  ...
  const handleSave = async () => {
    ...
    if (form.items.length === 0 || !form.items[0].product_name) {
  ...
  const parseOrderFromText = (text: string) => {
    ...
    return {
      items:
        items.length > 0
          ? items
          : [{ product_name: "Extracted Product", quantity: "1", price: "0" }],
        ...
        <DialogContent>
          ...
          {extractedData && (
            <Alert severity="success" sx={{ mt: 2 }}>
              ...
              <Typography variant="body2">
                Total: ₹{extractedData.total_amount || "Not found"}
              </Typography>
              <Button
                size="small"
