...
export default function StocksPage() {
  ...
  const handleSave = async () => {
    if (!form.vegetable || !form.quantity || !form.price_per_unit) {
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              {stocks.length} items · Total Value: ₹
            ...
            <TableBody>
              {loading ? (
                ...
                <TableRow>
                  ...
                  >
                    No stock entries. Add your first stock!
                  </TableCell>
                </TableRow>
              ) : (
                paginatedOrders.map((s) => (
                  <TableRow key={s.id} hover>
                    ...
                    <TableCell align="right">
                      ₹{Number(s.price_per_unit).toFixed(2)}
                    </TableCell>
                    <TableCell
                      align="right"
                    ...
                    <TableCell>
                      {s.purchase_date
                        ? new Date(s.purchase_date).toLocaleDateString("en-IN")
                        : "—"}
                    </TableCell>
          ...
          <Grid container spacing={2} sx={{ mt: 0.5 }}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  setForm({ ...form, vegetable: e.target.value })
                }
              >
                {VEGETABLES.map((v) => (
